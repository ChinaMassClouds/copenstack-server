...
// ************************** SVG utility methods ********************************************	
    ...
    var svgAttributeMap = {
        ...
        _pos = function (d) {
        	var left = d[0];
        	var top = d[1];
        	if(horizon && horizon.logic_topo){
        		if(horizon.logic_topo.svg_offset_x){
	        		left = d[0] + horizon.logic_topo.svg_offset_x;
        		}
        		if(horizon.logic_topo.svg_offset_y){
        			top = d[1] + horizon.logic_topo.svg_offset_y;
        		}
        	}
