...
from openstack_dashboard.dashboards.project.applyhost import console


class OverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = ("project/applyhost/"
...
class LogTab(tabs.Tab):
    name = _("Log")
    slug = "log"
    template_name = "project/applyhost/_detail_log.html"
    preload = False
...
class ConsoleTab(tabs.Tab):
    name = _("Console")
    slug = "console"
    template_name = "project/applyhost/_detail_console.html"
    preload = False
...
class AuditTab(tabs.TableTab):
    ...
    template_name = "project/applyhost/_detail_audit.html"
    preload = False
